...
class Dropdown extends _baseComponent.default {
  ...
  renderContent() {
    ...
    if ( /*#__PURE__*/_react.default.isValidElement(render)) {
      content = render;
    } else if ((0, _isArray.default)(menu)) {
  ...
  renderMenu() {
    ...
    const content = (0, _map.default)(menu).call(menu, (m, index) => {
      switch (m.node) {
        case 'title':
          {
            const {
            ...
            return /*#__PURE__*/_react.default.createElement(Dropdown.Title, (0, _assign.default)({}, rest, {
              key: node + name + index
            }), name);
          }
        ...
        case 'item':
          {
            ...
            return /*#__PURE__*/_react.default.createElement(Dropdown.Item, (0, _assign.default)({}, rest, {
              key: node + name + index
            }), name);
          }
