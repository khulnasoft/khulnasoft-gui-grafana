...
class GrafanaBootConfig {
    constructor(options) {
        ...
        this.theme2 = data.createTheme({ colors: { mode } });
 ...
 * @public
 */
const config$1 = new GrafanaBootConfig(options);
...
class HistoryWrapper {
    ...
    reload() {
        var _a;
        const prevState = (_a = this.history.location.state) === null || _a === void 0 ? void 0 : _a.routeReloadCounter;
        this.history.replace(Object.assign(Object.assign({}, this.history.location), { state: { routeReloadCounter: prevState ? prevState + 1 : 1 } }));
    }
    getLocation() {
...
function loadPluginCss(options) {
    const theme = config$1.bootData.user.lightTheme ? options.light : options.dark;
...
const reportPageview = () => {
    ...
    const page = `${(_a = config$1.appSubUrl) !== null && _a !== void 0 ? _a : ''}${location.pathname}${location.search}${location.hash}`;
    getEchoSrv().addEvent({
...
const reportExperimentView = (id, group, variant) => {
    getEchoSrv().addEvent({
        type: exports.EchoEventType.ExperimentView,
        payload: {
            experimentId: id,
...
const featureEnabled = (feature) => {
    const { enabledFeatures } = config$1.licenseInfo;
...
function toDataQueryResponse(res, queries) {
    ...
    if ((_a = res.data) === null || _a === void 0 ? void 0 : _a.results) {
        ...
        const refIDs = (queries === null || queries === void 0 ? void 0 : queries.length) ? queries.map((q) => q.refId) : Object.keys(results);
...
function addCacheNotice(frame) {
    ...
    return Object.assign(Object.assign({}, frame), { schema: Object.assign(Object.assign({}, frame.schema), { fields: [...((_b = (_a = frame.schema) === null || _a === void 0 ? void 0 : _a.fields) !== null && _b !== void 0 ? _b : [])], meta: Object.assign(Object.assign({}, (_c = frame.schema) === null || _c === void 0 ? void 0 : _c.meta), { notices: [...((_f = (_e = (_d = frame.schema) === null || _d === void 0 ? void 0 : _d.meta) === null || _e === void 0 ? void 0 : _e.notices) !== null && _f !== void 0 ? _f : []), cachedResponseNotice] }) }) });
}
/**
...
function isExpressionReference(ref) {
    ...
    const v = (_a = ref.type) !== null && _a !== void 0 ? _a : ref;
    ...
    query(request) {
        ...
        const queries = targets.map((q) => {
            ...
            if (isExpressionReference(q.datasource)) {
                return Object.assign(Object.assign({}, q), { datasource: ExpressionDatasourceRef });
            }
            if (q.datasource) {
            ...
            return Object.assign(Object.assign({}, this.applyTemplateVariables(q, request.scopedVars)), { datasource,
                datasourceId,
                intervalMs,
                maxDataPoints });
        });
        ...
        if (config$1.featureToggles.queryOverLive) {
        ...
        return getBackendSrv()
            ...
            if (((_a = rsp.data) === null || _a === void 0 ? void 0 : _a.length) && rsp.data.find((f) => { var _a; return (_a = f.meta) === null || _a === void 0 ? void 0 : _a.channel; })) {
...
function toStreamingDataResponse(rsp, req, getter) {
    ...
    for (const f of rsp.data) {
        const addr = data.parseLiveChannelAddress((_a = f.meta) === null || _a === void 0 ? void 0 : _a.channel);
        if (addr) {
            const frame = f;
    ...
    if (staticdata.length) {
        streams.push(of(Object.assign(Object.assign({}, rsp), { data: staticdata })));
    }
    if (streams.length === 1) {
...
const standardStreamOptionsProvider = (request, frame) => {
    ...
    const opts = {
        ...
        action: exports.StreamingFrameAction.Append,
    };
...
class DataSourcePicker extends React.PureComponent {
    ...
    render() {
        ...
        return (React__default["default"].createElement("div", { "aria-label": e2eSelectors.selectors.components.DataSourcePicker.container },
            React__default["default"].createElement(ui.Select, { "aria-label": e2eSelectors.selectors.components.DataSourcePicker.inputV2, inputId: inputId || 'data-source-picker', menuShouldPortal: true, className: "ds-picker select-container", isMulti: false, isClearable: isClearable, backspaceRemovesValue: false, onChange: this.onChange, options: options, autoFocus: autoFocus, onBlur: onBlur, width: width, openMenuOnFocus: openMenuOnFocus, maxMenuHeight: 500, placeholder: placeholder, noOptionsMessage: "No datasources found", value: value !== null && value !== void 0 ? value : null, invalid: !!error, getOptionLabel: (o) => {
