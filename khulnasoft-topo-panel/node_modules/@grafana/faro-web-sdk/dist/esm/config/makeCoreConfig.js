...
export function makeCoreConfig(browserConfig) {
    ...
    return {
        ...
        eventDomain: (_k = browserConfig.eventDomain) !== null && _k !== void 0 ? _k : defaultEventDomain,
    };
}
