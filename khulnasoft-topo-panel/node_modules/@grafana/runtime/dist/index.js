...
function logError(err, contexts) {
  if (config.grafanaJavascriptAgent.enabled) {
    faroWebSdk.faro.api.pushLog([err.message], {
      level: faroWebSdk.LogLevel.ERROR,
      context: contexts
    });
  }
  if (config.sentry.enabled) {
...
function isExpressionReference(ref) {
  ...
  const v = (_a = ref.type) != null ? _a : ref;
  return v === ExpressionDatasourceRef.type || v === "-100";
}
...
class DataSourcePicker extends React.PureComponent {
  ...
  render() {
    ...
    return /* @__PURE__ */ React__default["default"].createElement("div", {
      "aria-label": e2eSelectors.selectors.components.DataSourcePicker.container
      ...
      getOptionLabel: (o) => {
        if (o.meta && data.isUnsignedPluginSignature(o.meta.signature) && o !== value) {
          return /* @__PURE__ */ React__default["default"].createElement(ui.HorizontalGroup, {
            align: "center",
            justify: "space-between",
            height: "auto"
          }, /* @__PURE__ */ React__default["default"].createElement("span", null, o.label), " ", /* @__PURE__ */ React__default["default"].createElement(ui.PluginSignatureBadge, {
