...
const preferredVisualizationTypes = ["graph", "table", "logs", "trace", "nodeGraph", "flamegraph"];
...
function updateDatasourcePluginOption(props, key, val) {
  ...
  props.onOptionsChange(__spreadProps$A(__spreadValues$I({}, config), {
    [key]: val
  }));
}
const updateDatasourcePluginJsonDataOption = (props, key, val) => {
  const config = props.options;
  props.onOptionsChange(__spreadProps$A(__spreadValues$I({}, config), {
    jsonData: __spreadProps$A(__spreadValues$I({}, config.jsonData), {
      [key]: val
    })
  }));
};
const updateDatasourcePluginSecureJsonDataOption = (props, key, val) => {
  const config = props.options;
  props.onOptionsChange(__spreadProps$A(__spreadValues$I({}, config), {
    secureJsonData: __spreadProps$A(__spreadValues$I({}, config.secureJsonData ? config.secureJsonData : {}), {
      [key]: val
    })
  }));
};
const updateDatasourcePluginResetOption = (props, key) => {
  ...
  props.onOptionsChange(__spreadProps$A(__spreadValues$I({}, config), {
    ...
    secureJsonFields: __spreadProps$A(__spreadValues$I({}, config.secureJsonFields), {
      [key]: false
    })
  }));
};
...
const mapInternal = (zone, timestamp) => {
  ...
  switch (zone) {
    ...
    case "" /* default */: {
      ...
      return __spreadProps$z(__spreadValues$H({
...
function parseDuration(durationString) {
  return durationString.split(" ").reduce((acc, value) => {
    ...
    return mapping ? __spreadProps$y(__spreadValues$G({}, acc), { [mapping[0]]: length }) : acc;
  }, {});
}
...
function findUniqueLabels(labels, commonLabels) {
  const uncommonLabels = __spreadValues$F({}, labels);
...
function locale(value, decimals) {
  ...
  return {
    text: value.toLocaleString(void 0, { maximumFractionDigits: decimals })
  };
}
...
function dataFrameFromJSON(dto) {
  ...
  return __spreadProps$x(__spreadValues$E({}, schema), {
    fields,
    length
  });
}
...
const guessFieldTypes = (series, guessDefined = false) => {
  for (const field of series.fields) {
    if (!field.type || field.type === FieldType.other || guessDefined) {
      return __spreadProps$w(__spreadValues$D({}, series), {
        fields: series.fields.map((field2) => {
          if (field2.type && field2.type !== FieldType.other && !guessDefined) {
            return field2;
          }
          return __spreadProps$w(__spreadValues$D({}, field2), {
...
function sortDataFrame(data, sortIndex, reverse = false) {
  ...
  return __spreadProps$w(__spreadValues$D({}, data), {
    fields: data.fields.map((f) => {
      return __spreadProps$w(__spreadValues$D({}, f), {
...
class MutableDataFrame extends FunctionalVector {
  ...
  addField(f, startLength) {
    ...
    const field = __spreadProps$v(__spreadValues$C({}, f), {
      name,
      type,
      config: f.config || {},
...
class DataFrameView extends FunctionalVector {
  ...
  toArray() {
    return new Array(this.data.length).fill(0).map((_, i) => __spreadValues$B({}, this.get(i)));
  }
}
...
var FrameMatcherID = /* @__PURE__ */ ((FrameMatcherID2) => {
  ...
  FrameMatcherID2["byLabel"] = "byLabel";
...
const sanitizeXSS = new xss__namespace.FilterXSS({
  whiteList: XSSWL
});
const sanitizeTextPanelWhitelist = new xss__namespace.FilterXSS({
  whiteList: XSSWL,
  css: {
    whiteList: __spreadProps$u(__spreadValues$A({}, xss__namespace.getDefaultCSSWhiteList()), {
      "flex-direction": true,
      "flex-wrap": true,
      "flex-basis": true,
      "flex-grow": true,
...
function renderMarkdown(str, options) {
  ...
  if (options == null ? void 0 : options.breaks) {
    opts = __spreadProps$t(__spreadValues$z({}, markdownOptions), {
      breaks: true
    });
  }
...
function reduceField(options) {
  ...
  if ((_a = field.state) == null ? void 0 : _a.calcs) {
    ...
    if (missing.length < 1) {
      return __spreadValues$y({}, field.state.calcs);
    }
  }
  if (!field.state) {
    field.state = {};
  ...
  if (data.length < 1) {
    const calcs = __spreadValues$y({}, field.state.calcs);
  ...
  if (queue.length === 1 && queue[0].reduce) {
    ...
    field.state.calcs = __spreadValues$y(__spreadValues$y({}, field.state.calcs), values2);
    return values2;
  }
  let values = doStandardCalcs(field, ignoreNulls, nullAsZero);
  for (const reducer of queue) {
    if (!values.hasOwnProperty(reducer.id) && reducer.reduce) {
      values = __spreadValues$y(__spreadValues$y({}, values), reducer.reduce(field, ignoreNulls, nullAsZero));
    }
  }
  field.state.calcs = __spreadValues$y(__spreadValues$y({}, field.state.calcs), values);
  return values;
}
...
class FieldCache {
  constructor(data) {
    ...
    this.fieldByName = {};
    this.fieldByType = {};
    this.fields = data.fields.map((field, idx) => __spreadProps$s(__spreadValues$x({}, field), {
      index: idx
    }));
    for (let i = 0; i < data.fields.length; i++) {
      const field = data.fields[i];
      ...
      this.fieldByType[field.type].push(__spreadProps$s(__spreadValues$x({}, field), {
        index: i
      }));
      if (this.fieldByName[field.name]) {
        console.warn("Duplicate field names in DataFrame: ", field.name);
      } else {
        this.fieldByName[field.name] = __spreadProps$s(__spreadValues$x({}, field), { index: i });
      }
    }
  }
  getFields(type) {
...
class CircularDataFrame extends MutableDataFrame {
  constructor(options) {
    super(void 0, (buffer) => {
      return new CircularVector(__spreadProps$r(__spreadValues$w({}, options), {
        buffer
      }));
    });
  }
...
function joinDataFrames(options) {
  ...
  if (options.frames.length === 1) {
    ...
    if (options.keepOriginIndices) {
      frameCopy = __spreadProps$q(__spreadValues$v({}, frame), {
  ...
  for (let frameIndex = 0; frameIndex < options.frames.length; frameIndex++) {
    ...
    for (let fieldIndex = 0; fieldIndex < frame.fields.length; fieldIndex++) {
      ...
      if (!join2 && joinFieldMatcher(field, frame, options.frames)) {
        ...
        if (frame.name) {
          labels = __spreadProps$q(__spreadValues$v({}, labels), { name: frame.name });
        }
        fields.push(__spreadProps$q(__spreadValues$v({}, field), {
          labels
        }));
      }
      if (options.keepOriginIndices) {
  ...
  return {
    ...
    fields: originalFields.map((f, index) => __spreadProps$q(__spreadValues$v({}, f), {
...
const joinByFieldTransformer = {
  ...
  operator: (options) => (source) => source.pipe(operators.map((data) => joinByFieldTransformer.transformer(options)(data))),
  transformer: (options) => {
    let joinBy = void 0;
    return (data) => {
      if (data.length > 1) {
...
const ensureColumnsTransformer = {
  ...
  operator: (options) => (source) => source.pipe(operators.map((data) => ensureColumnsTransformer.transformer(options)(data))),
    ...
    return outerSource.pipe(
      ...
      operators.map((data) => {
        ...
        if (mode === "reduceRow" /* ReduceRow */) {
          ...
          const binaryOptions = replace ? __spreadProps$p(__spreadValues$u({}, options.binary), {
            left: replace ? replace((_b = options.binary) == null ? void 0 : _b.left) : (_c = options.binary) == null ? void 0 : _c.left,
            right: replace ? replace((_d = options.binary) == null ? void 0 : _d.right) : (_e = options.binary) == null ? void 0 : _e.right
          }) : options.binary;
        ...
        return data.map((frame) => {
          ...
          return __spreadProps$p(__spreadValues$u({}, frame), {
            fields
          });
        });
      })
...
function getNameFromOptions(options) {
  ...
  if (options.mode === "binary" /* BinaryOperation */) {
  ...
  if (options.mode === "reduceRow" /* ReduceRow */) {
...
function concatenateFields(data, opts) {
  ...
  if (!sameLength) {
    fields = fields.map((f) => {
      ...
      return __spreadProps$o(__spreadValues$t({}, f), {
        values: new ArrayVector(values)
      });
    });
  }
...
const convertFieldTypeTransformer = {
  ...
  operator: (options) => (source) => source.pipe(operators.map((data) => convertFieldTypeTransformer.transformer(options)(data))),
...
function fieldToTimeField(field, dateFormat) {
  ...
  return __spreadProps$n(__spreadValues$s({}, field), {
    type: FieldType.time,
  ...
  operator: (options, replace) => (source) => {
    ...
    if (replace) {
      if (typeof ((_a = options.include) == null ? void 0 : _a.options) === "string") {
        options.include.options = replace((_b = options.include) == null ? void 0 : _b.options);
      } else if (typeof ((_d = (_c = options.include) == null ? void 0 : _c.options) == null ? void 0 : _d.pattern) === "string") {
        options.include.options.pattern = replace((_e = options.include) == null ? void 0 : _e.options.pattern);
      }
      if (typeof ((_f = options.exclude) == null ? void 0 : _f.options) === "string") {
        options.exclude.options = replace((_g = options.exclude) == null ? void 0 : _g.options);
      } else if (typeof ((_i = (_h = options.exclude) == null ? void 0 : _h.options) == null ? void 0 : _i.pattern) === "string") {
        options.exclude.options.pattern = replace((_j = options.exclude) == null ? void 0 : _j.options.pattern);
      }
    }
    return source.pipe(
      operators.map((data) => {
        ...
        for (const series of data) {
          ...
          const copy = __spreadProps$m(__spreadValues$r({}, series), {
            fields
          });
          processed.push(copy);
        }
      ...
      operators.map((data) => {
        ...
        for (const frame of data) {
          ...
          for (const field of frame.fields) {
            ...
            fields.push(__spreadProps$l(__spreadValues$q({}, field), {
              values: new ArrayVector(buffer),
              state: {}
            }));
          }
          processed.push(__spreadProps$l(__spreadValues$q({}, frame), {
            fields,
            length: frameLength
          }));
        }
    ...
    operators.map((data) => {
      ...
      for (const columnName of columnValues) {
        ...
        for (const rowName of rowValues) {
          const value = (_a = matrixValues[columnName][rowName]) != null ? _a : "";
          values.push(value);
        }
        resultFrame.addField({
...
function createColors(colors) {
  ...
  const getRichColor = ({ color, name }) => {
    color = __spreadProps$k(__spreadValues$o({}, color), { name });
    if (!color.main) {
  ...
  return lodash.merge(
    __spreadProps$k(__spreadValues$o({}, base), {
...
function createTypography(colors, typographyInput = {}) {
  ...
  const buildVariant = (fontWeight, size2, lineHeight, letterSpacing, casing) => {
    ...
    return __spreadValues$n(__spreadValues$n({
      fontFamily,
      fontWeight,
...
function createV1Theme(theme) {
  ...
  const basicColors = __spreadProps$j(__spreadValues$m({}, commonColorsPalette), {
    black: "#000000",
    white: "#ffffff",
    dark1: "#141414",
    dark2: "#161719",
  ...
  return __spreadProps$j(__spreadValues$m({}, oldCommon), {
    type: theme.colors.mode === "dark" ? GrafanaThemeType.Dark : GrafanaThemeType.Light,
    isDark: theme.isDark,
    isLight: theme.isLight,
    name: theme.name,
    palette: __spreadProps$j(__spreadValues$m({}, basicColors), {
    ...
    colors: __spreadProps$j(__spreadValues$m(__spreadValues$m(__spreadValues$m(__spreadValues$m({}, backgrounds), borders), form), textColors), {
...
function createTheme(options = {}) {
  ...
  const theme = {
    ...
    transitions,
    visualization,
    zIndex: __spreadValues$l({}, zIndex),
    flags: {}
  };
  return __spreadProps$i(__spreadValues$l({}, theme), {
...
const histogramTransformer = {
  ...
  operator: (options) => (source) => source.pipe(operators.map((data) => histogramTransformer.transformer(options)(data))),
  transformer: (options) => (data) => {
    if (!Array.isArray(data) || data.length === 0) {
      return data;
    }
...
const labelsToFieldsTransformer = {
  ...
  defaultOptions: {},
  operator: (options) => (source) => source.pipe(operators.map((data) => labelsToFieldsTransformer.transformer(options)(data))),
  transformer: (options) => (data) => {
    var _a, _b;
...
const getOperator = (config) => (source) => {
  ...
  return source.pipe(
    operators.mergeMap(
      (before) => rxjs.of(before).pipe(info.transformation.operator(options, config.replace), postProcessTransform(before, info))
    )
  );
};
    ...
    switch (vm.type) {
      ...
      case MappingType.RegexToText:
        ...
        if (value.match(regex)) {
          const res = __spreadValues$9({}, vm.options.result);
          if (res.text != null) {
    ...
    for (let i = 0; i < panel.valueMaps.length; i++) {
      ...
      mappings.push(
        upgradeOldAngularValueMapping(
          __spreadProps$7(__spreadValues$9({}, map), {
            id: i,
...
function getFieldConfigWithMinMax(field, local) {
  ...
  if (local || !((_a = field.state) == null ? void 0 : _a.range)) {
    return __spreadValues$8(__spreadValues$8({}, config), getMinMaxAndDelta(field));
  }
  return __spreadValues$8(__spreadValues$8({}, config), field.state.range);
}
  ...
  for (let s = 0; s < data.length && !hitLimit; s++) {
    ...
    for (let i = 0; i < dataFrame.fields.length && !hitLimit; i++) {
      ...
      if ((_b = field.state) == null ? void 0 : _b.range) {
        config = __spreadValues$7(__spreadValues$7({}, config), (_c = field.state) == null ? void 0 : _c.range);
      }
      ...
      if (reduceOptions.values) {
        ...
        for (let j = 0; j < field.values.length; j++) {
          ...
          values.push({
            name: "",
            field: config,
            display: __spreadProps$6(__spreadValues$7({}, displayValue), {
              title: rowName,
        ...
        for (const calc of calcs) {
          ...
          if (displayName !== "") {
            displayValue.title = replaceVariables(displayName, __spreadValues$7(__spreadValues$7({}, (_f = field.state) == null ? void 0 : _f.scopedVars), scopedVars));
          } else {
...
function getSmartDisplayNameForRow(frame, field, rowIndex, replaceVariables, scopedVars) {
  ...
  if (field.config.displayName) {
    return replaceVariables(field.config.displayName, __spreadValues$7(__spreadValues$7({}, (_a = field.state) == null ? void 0 : _a.scopedVars), scopedVars));
  }
...
function setIndexForPaletteColor(field, currentLength) {
  return __spreadProps$6(__spreadValues$7({}, field.state), {
...
function createNoValuesFieldDisplay(options) {
  ...
  return {
    name: displayName,
    field: __spreadProps$6(__spreadValues$7({}, defaults), {
    ...
    {},
    {
      get: (obj, key, reciever) => {
        ...
        if (key === "labels" || key === "formattedLabels") {
          ...
          return __spreadProps$5(__spreadValues$6({}, field.labels), {
...
function applyFieldOverrides(options) {
  ...
  return options.data.map((originalFrame, index) => {
    var _a2, _b;
    const newFrame = __spreadValues$5({}, originalFrame);
    newFrame.fields = newFrame.fields.map((field) => {
      return __spreadProps$4(__spreadValues$5({}, field), {
        config: lodash.cloneDeep(field.config),
        state: __spreadValues$5({}, field.state)
      });
    });
    const scopedVars = {
    ...
    for (const field of newFrame.fields) {
      ...
      field.state.scopedVars = __spreadProps$4(__spreadValues$5({}, scopedVars), {
        __field: {
          text: "Field",
...
const getLinksSupplier = (frame, field, fieldScopedVars, replaceVariables, timeZone) => (config) => {
  ...
  return field.config.links.map((link) => {
    ...
    const variables = __spreadProps$4(__spreadValues$5(__spreadProps$4(__spreadValues$5({}, fieldScopedVars), {
      __value: {
        text: "Value",
        value: valueVars
      }
...
function applyRawFieldOverrides(data) {
  ...
  for (let frameIndex = 0; frameIndex < newData.length; frameIndex++) {
    const newFrame = __spreadValues$5({}, newData[frameIndex]);
    const newFields = [...newFrame.fields];
    for (let fieldIndex = 0; fieldIndex < newFields.length; fieldIndex++) {
      newFields[fieldIndex] = __spreadProps$4(__spreadValues$5({}, newFields[fieldIndex]), {
        display: processor
      });
    }
    newData[frameIndex] = __spreadProps$4(__spreadValues$5({}, newFrame), {
      fields: newFields
    });
  }
  return newData;
...
class CSVReader {
  ...
  readCSV(text) {
    ...
    const papacfg = __spreadProps$3(__spreadValues$4({}, this.config), {
      dynamicTyping: false,
      skipEmptyLines: true,
      comments: false,
      chunk: this.chunk
...
function addLogLevelToSeries(series, lineIndex) {
  ...
  return __spreadProps$2(__spreadValues$3({}, series), {
    fields: [
      ...series.fields,
      {
        name: "LogLevel",
...
const sortLogsResult = (logsResult, sortOrder) => {
  ...
  return logsResult ? __spreadProps$2(__spreadValues$3({}, logsResult), { rows }) : { hasUniqueLabels: false, rows };
};
...
class FieldConfigEditorBuilder extends OptionsUIRegistryBuilder {
  addNumberInput(config) {
    var _a;
    return this.addCustomEditor(__spreadProps$1(__spreadValues$2({}, config), {
      id: config.path,
...
function createFieldConfigRegistry(config = {}, pluginName) {
  ...
  for (let fieldConfigProp of standardConfigs) {
    ...
    if (config.standardOptions) {
      ...
      if (customDefault) {
        fieldConfigProp = __spreadProps(__spreadValues$1({}, fieldConfigProp), {
          defaultValue: customDefault
        });
      }
      if (customSettings) {
        fieldConfigProp = __spreadProps(__spreadValues$1({}, fieldConfigProp), {
          settings: fieldConfigProp.settings ? __spreadValues$1(__spreadValues$1({}, fieldConfigProp.settings), customSettings) : customSettings
        });
      }
    }
