...
class BarGauge extends PureComponent {
  ...
  renderBasicAndGradientBars() {
    ...
    return /* @__PURE__ */ React__default.createElement("div", {
      style: styles.wrapper
    }, /* @__PURE__ */ React__default.createElement(FormattedValueDisplay, {
      "data-testid": selectors.components.Panels.Visualization.BarGauge.valueV2,
      value,
      style: styles.value
    }), showUnfilled && /* @__PURE__ */ React__default.createElement("div", {
  ...
  renderRetroBars() {
    ...
    for (let i = 0; i < cellCount; i++) {
      ...
      cells.push(/* @__PURE__ */ React__default.createElement("div", {
        key: i.toString(),
        style: cellStyles
      }));
    }
    ...
    }, cells, /* @__PURE__ */ React__default.createElement(FormattedValueDisplay, {
      "data-testid": selectors.components.Panels.Visualization.BarGauge.valueV2,
      value,
      style: valueStyles
    }));
...
export { BarGauge, BarGaugeDisplayMode, calculateBarAndValueDimensions, getBarGradient, getBasicAndGradientStyles, getCellColor, getTitleStyles, getValueColor, getValuePercent };
