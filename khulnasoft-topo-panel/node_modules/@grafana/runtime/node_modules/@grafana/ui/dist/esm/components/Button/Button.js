...
const Button = React__default.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React__default.createElement("button", __spreadProps(__spreadValues({
...
const LinkButton = React__default.forwardRef(
  (_c, ref) => {
    ...
    const button = /* @__PURE__ */ React__default.createElement("a", __spreadProps(__spreadValues({
...
export { Button, LinkButton, clearButtonStyles, getButtonStyles, getPropertiesForVariant };
