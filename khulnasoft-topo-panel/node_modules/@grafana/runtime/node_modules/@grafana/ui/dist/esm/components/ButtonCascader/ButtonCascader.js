...
const ButtonCascader = (props) => {
  ...
  if (!hideDownIcon) {
    content = [props.children, /* @__PURE__ */ React__default.createElement(Icon, {
      key: "down-icon",
      name: "angle-down",
      className: styles.icons.right
    })];
  }
  return /* @__PURE__ */ React__default.createElement(RCCascader, __spreadProps(__spreadValues({
    ...
    disabled,
    variant
  }, buttonProps != null ? buttonProps : {}), content));
};
