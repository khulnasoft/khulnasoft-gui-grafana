...
const Card = (_a) => {
  var _b = _a, { disabled, href, onClick, children, isSelected, className } = _b, htmlProps = __objRest(_b, ["disabled", "href", "onClick", "children", "isSelected", "className"]);
  const hasHeadingComponent = useMemo(
    () => React__default.Children.toArray(children).some(
      (c) => React__default.isValidElement(c) && c.type.displayName === Heading.displayName
    ),
    [children]
  );
  ...
  return /* @__PURE__ */ React__default.createElement(CardContainer, __spreadValues({
    disableEvents: disabled,
    disableHover,
    isSelected,
    className: cx(styles.container, className)
  }, htmlProps), /* @__PURE__ */ React__default.createElement(CardContext.Provider, {
    value: { href, onClick: onCardClick, disabled, isSelected }
  }, !hasHeadingComponent && /* @__PURE__ */ React__default.createElement(Heading, null), children));
};
const Heading = ({ children, className, "aria-label": ariaLabel }) => {
  ...
  }, href ? /* @__PURE__ */ React__default.createElement("a", {
    href,
    className: styles.linkHack,
    "aria-label": ariaLabel,
    onClick
  }, children) : onClick ? /* @__PURE__ */ React__default.createElement("button", {
    onClick,
    className: styles.linkHack,
    "aria-label": ariaLabel,
    type: "button"
  }, children) : /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, children), isSelected !== void 0 && /* @__PURE__ */ React__default.createElement("input", {
    "aria-label": "option",
    type: "radio",
    readOnly: true,
    checked: isSelected
...
const Tags = ({ children, className }) => {
  ...
  return /* @__PURE__ */ React__default.createElement("div", {
    className: cx(styles.tagList, className)
  }, children);
};
...
const Meta = memo(({ children, className, separator = "|" }) => {
  ...
  meta = filtered.map((element, i) => /* @__PURE__ */ React__default.createElement("div", {
    key: `element_${i}`,
...
const Actions = ({ children, disabled, className }) => {
  return /* @__PURE__ */ React__default.createElement(BaseActions, {
    variant: "primary",
    disabled,
    className
  }, children);
