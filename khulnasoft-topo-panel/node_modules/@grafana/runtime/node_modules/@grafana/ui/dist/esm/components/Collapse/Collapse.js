...
const ControlledCollapse = (_a) => {
  ...
  return /* @__PURE__ */ React__default.createElement(Collapse, __spreadProps(__spreadValues({
    isOpen: open,
    collapsible: true
  }, otherProps), {
    onToggle: () => {
...
const Collapse = ({
  ...
  return /* @__PURE__ */ React__default.createElement("div", {
    ...
    type: "button",
    className: cx(buttonStyles, headerClass),
    onClick: onClickToggle
  }, collapsible && /* @__PURE__ */ React__default.createElement(Icon, {
    className: style.icon,
    name: isOpen ? "angle-down" : "angle-right"
  }), /* @__PURE__ */ React__default.createElement("div", {
    className: cx([style.headerLabel])
  }, label)), isOpen && /* @__PURE__ */ React__default.createElement("div", {
    className: cx([style.collapseBody])
  }, /* @__PURE__ */ React__default.createElement("div", {
    className: loaderClass
  }), /* @__PURE__ */ React__default.createElement("div", {
    className: style.bodyContentWrapper
  }, children)));
};
