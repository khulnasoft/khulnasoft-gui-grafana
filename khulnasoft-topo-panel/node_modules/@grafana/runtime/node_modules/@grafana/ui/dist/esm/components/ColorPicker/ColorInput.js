...
const ColorInput = forwardRef(
  (_a, ref) => {
    var _b = _a, { color, onChange, isClearable = false } = _b, inputProps = __objRest(_b, ["color", "onChange", "isClearable"]);
    ...
    return /* @__PURE__ */ React__default.createElement(Input, __spreadProps(__spreadValues({}, inputProps), {
      value,
      onChange: onChangeColor,
      onBlur,
      addonBefore: /* @__PURE__ */ React__default.createElement(ColorPreview, {
        color
      }),
      ref
    }));
