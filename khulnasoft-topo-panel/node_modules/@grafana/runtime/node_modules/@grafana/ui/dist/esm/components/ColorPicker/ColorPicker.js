...
const colorPickerFactory = (popover, displayName = "ColorPicker") => {
  ...
  return _a = class extends Component {
    ...
    render() {
      ...
      return /* @__PURE__ */ React__default.createElement(PopoverController, {
        content: popoverElement,
        hideAfter: 300
      }, (showPopper, hidePopper, popperProps) => {
        return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, this.pickerTriggerRef.current && /* @__PURE__ */ React__default.createElement(Popover, __spreadProps(__spreadValues({}, popperProps), {
