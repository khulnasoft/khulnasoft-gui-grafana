...
const ColorPickerInput = forwardRef(
  (_a, ref) => {
    ...
    }, isOpen && !inputProps.disabled && /* @__PURE__ */ React__default.createElement(RgbaStringColorPicker, {
    ...
    }, /* @__PURE__ */ React__default.createElement(ColorInput, __spreadProps(__spreadValues({}, inputProps), {
      theme,
      color: currentColor,
      onChange: setColor,
      ref,
