...
class UnThemedColorPickerPopover extends Component {
  constructor(props) {
    ...
    this.renderPicker = () => {
      ...
      switch (activePicker) {
        case "spectrum":
          return /* @__PURE__ */ React__default.createElement(SpectrumPalette, {
            color,
            onChange: this.handleChange
          });
        case "palette":
          return /* @__PURE__ */ React__default.createElement(NamedColorsPalette, {
            color,
            onChange: this.handleChange
          });
        default:
  ...
  render() {
    ...
    }, "Colors"), /* @__PURE__ */ React__default.createElement("button", {
      className: this.getTabClassName("spectrum"),
      onClick: this.onTabChange("spectrum")
    }, "Custom"), this.renderCustomPickerTabs()), /* @__PURE__ */ React__default.createElement("div", {
