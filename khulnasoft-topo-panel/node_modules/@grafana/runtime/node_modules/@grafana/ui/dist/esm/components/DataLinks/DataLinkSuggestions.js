...
const DataLinkSuggestions = (_a) => {
  ...
  return /* @__PURE__ */ React__default.createElement("div", {
    ...
    return /* @__PURE__ */ React__default.createElement(DataLinkSuggestionsList, __spreadProps(__spreadValues({}, otherProps), {
...
const DataLinkSuggestionsList = React__default.memo(
  ({ activeIndex, activeIndexOffset, label, onClose, onSuggestionSelect, suggestions, activeRef: selectedRef }) => {
    const styles = useStyles2(getStyles);
    return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement(List, {
