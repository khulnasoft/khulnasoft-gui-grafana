...
const DataLinksContextMenu = ({ children, links, style }) => {
  ...
  const renderMenuGroupItems = () => {
    return itemsGroup.map((group, index) => /* @__PURE__ */ React__default.createElement(MenuGroup, {
  ...
  `;
  if (linksCounter > 1) {
    return /* @__PURE__ */ React__default.createElement(WithContextMenu, {
    ...
    return /* @__PURE__ */ React__default.createElement("a", {
      ...
      style: __spreadProps(__spreadValues({}, style), { overflow: "hidden", display: "flex", flexGrow: 1 }),
