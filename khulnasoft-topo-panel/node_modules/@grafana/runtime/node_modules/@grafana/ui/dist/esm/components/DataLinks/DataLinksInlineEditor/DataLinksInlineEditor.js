...
const DataLinksInlineEditor = ({
  ...
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, linksSafe.length > 0 && /* @__PURE__ */ React__default.createElement("div", {
    className: styles.wrapper
  }, linksSafe.map((l, i) => {
    return /* @__PURE__ */ React__default.createElement(DataLinksListItem, {
      key: `${l.title}/${i}`,
      index: i,
      link: l,
  ...
  })), isEditing && editIndex !== null && /* @__PURE__ */ React__default.createElement(Modal, {
    title: "Edit link",
    isOpen: true,
  ...
  }, /* @__PURE__ */ React__default.createElement(DataLinkEditorModalContent, {
    index: editIndex,
