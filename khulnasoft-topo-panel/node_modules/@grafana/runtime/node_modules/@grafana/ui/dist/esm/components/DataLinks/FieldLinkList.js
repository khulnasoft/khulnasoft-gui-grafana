...
function FieldLinkList({ links }) {
  ...
  if (links.length === 1) {
    return /* @__PURE__ */ React__default.createElement(DataLinkButton, {
      link: links[0]
    });
  }
  ...
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, internalLinks.map((link, i) => {
    ...
    className: styles.externalLinksHeading
  }, "External links"), externalLinks.map((link, i) => /* @__PURE__ */ React__default.createElement("a", {
    key: i,
    href: link.href,
    target: link.target,
