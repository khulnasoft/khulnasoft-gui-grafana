...
const CertificationKey = ({ hasCert, label, onChange, onClick, placeholder }) => {
  return /* @__PURE__ */ React__default.createElement(InlineFieldRow, null, /* @__PURE__ */ React__default.createElement(InlineField, {
    label,
    labelWidth: 14,
    disabled: hasCert
  }, hasCert ? /* @__PURE__ */ React__default.createElement(Input, {
    type: "text",
    value: "configured",
    width: 24
    ...
    placeholder,
    required: true
  })), hasCert && /* @__PURE__ */ React__default.createElement(Button, {
    variant: "secondary",
    onClick,
    style: { marginLeft: 4 }
  }, "Reset"));
