...
const CustomHeaderRow = ({ header, onBlur, onChange, onRemove, onReset }) => {
  ...
  return /* @__PURE__ */ React__default.createElement("div", {
    ...
    onBlur
  }), /* @__PURE__ */ React__default.createElement(SecretFormField, {
    label: "Value",
    "aria-label": "Value",
    name: "value",
...
class CustomHeadersSettings extends PureComponent {
  ...
  render() {
    ...
    return /* @__PURE__ */ React__default.createElement("div", {
      ...
      className: "gf-form"
    }, /* @__PURE__ */ React__default.createElement("h6", null, "Custom HTTP Headers")), /* @__PURE__ */ React__default.createElement("div", null, headers.map((header, i) => /* @__PURE__ */ React__default.createElement(CustomHeaderRow, {
      key: header.id,
      header,
      onChange: (h) => {
