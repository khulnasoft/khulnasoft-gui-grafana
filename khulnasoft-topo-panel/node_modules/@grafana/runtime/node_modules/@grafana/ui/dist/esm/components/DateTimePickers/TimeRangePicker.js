...
function TimeRangePicker(props) {
  ...
  return /* @__PURE__ */ React__default.createElement(ButtonGroup, {
  ...
  }, hasAbsolute && /* @__PURE__ */ React__default.createElement(ToolbarButton, {
    ...
    content: /* @__PURE__ */ React__default.createElement(TimePickerTooltip, {
      timeRange: value,
      timeZone
    }),
    placement: "bottom",
    ...
    isOpen,
    variant
  }, /* @__PURE__ */ React__default.createElement(TimePickerButtonLabel, __spreadValues({}, props)))), isOpen && /* @__PURE__ */ React__default.createElement("div", null, /* @__PURE__ */ React__default.createElement("div", __spreadValues({
    role: "presentation",
    className: cx(modalBackdrop, styles.backdrop)
  }, underlayProps)), /* @__PURE__ */ React__default.createElement(FocusScope, {
    contain: true,
    autoFocus: true
  }, /* @__PURE__ */ React__default.createElement("section", __spreadValues(__spreadValues({
    className: styles.content,
    ref
  }, overlayProps), dialogProps), /* @__PURE__ */ React__default.createElement(TimePickerContent, {
    timeZone,
    fiscalYearStartMonth,
    value,
    onChange,
    ...
    onChangeFiscalYearStartMonth,
    hideQuickRanges
  })))), timeSyncButton, hasAbsolute && /* @__PURE__ */ React__default.createElement(ToolbarButton, {
...
const ZoomOutTooltip = () => /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement(Trans, {
  i18nKey: "time-picker.range-picker.zoom-out-tooltip"
}, "Time range zoom out ", /* @__PURE__ */ React__default.createElement("br", null), " CTRL+Z"));
const TimePickerTooltip = ({ timeRange, timeZone }) => {
  const styles = useStyles2(getLabelStyles);
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, dateTimeFormat(timeRange.from, { timeZone }), /* @__PURE__ */ React__default.createElement("div", {
    className: "text-center"
  }, /* @__PURE__ */ React__default.createElement(Trans, {
    i18nKey: "time-picker.range-picker.to"
  }, "to")), dateTimeFormat(timeRange.to, { timeZone }), /* @__PURE__ */ React__default.createElement("div", {
    className: "text-center"
...
const TimePickerButtonLabel = memo(({ hideText, value, timeZone }) => {
  ...
  return /* @__PURE__ */ React__default.createElement("span", {
    className: styles.container
  }, /* @__PURE__ */ React__default.createElement("span", null, formattedRange(value, timeZone)), /* @__PURE__ */ React__default.createElement("span", {
    className: styles.utc
  }, rangeUtil.describeTimeRangeAbbreviation(value, timeZone)));
});
...
export { TimePickerButtonLabel, TimeRangePicker };
