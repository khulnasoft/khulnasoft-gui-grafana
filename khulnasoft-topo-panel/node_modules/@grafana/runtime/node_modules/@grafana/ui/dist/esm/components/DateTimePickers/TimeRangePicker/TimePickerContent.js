...
const TimePickerContentWithScreenSize = (props) => {
  ...
  }, (!isFullscreen || !hideQuickRanges) && /* @__PURE__ */ React__default.createElement("div", {
    className: styles.rightSide
  }, /* @__PURE__ */ React__default.createElement("div", {
    className: styles.timeRangeFilter
  }, /* @__PURE__ */ React__default.createElement(FilterInput, {
    width: 0,
    autoFocus: true,
    value: searchTerm,
    onChange: setSearchQuery,
    placeholder: t("time-picker.content.filter-placeholder", "Search quick ranges")
  })), /* @__PURE__ */ React__default.createElement(CustomScrollbar, null, !isFullscreen && /* @__PURE__ */ React__default.createElement(NarrowScreenForm, __spreadProps(__spreadValues({}, props), {
    historyOptions
  })), !hideQuickRanges && /* @__PURE__ */ React__default.createElement(TimeRangeList, {
    options: filteredQuickOptions,
    onChange: onChangeTimeOption,
    value: timeOption
  }))), isFullscreen && /* @__PURE__ */ React__default.createElement("div", {
    className: styles.leftSide
  }, /* @__PURE__ */ React__default.createElement(FullScreenForm, __spreadProps(__spreadValues({}, props), {
    historyOptions
  })))), !hideTimeZone && isFullscreen && /* @__PURE__ */ React__default.createElement(TimePickerFooter, {
    timeZone,
    fiscalYearStartMonth,
    onChangeTimeZone,
    onChangeFiscalYearStartMonth
...
const TimePickerContent = (props) => {
  ...
  return /* @__PURE__ */ React__default.createElement(TimePickerContentWithScreenSize, __spreadProps(__spreadValues({}, props), {
    isFullscreen
  }));
};
const NarrowScreenForm = (props) => {
  ...
  return /* @__PURE__ */ React__default.createElement("fieldset", null, /* @__PURE__ */ React__default.createElement("div", {
  ...
  }, /* @__PURE__ */ React__default.createElement(TimePickerTitle, null, /* @__PURE__ */ React__default.createElement(Trans, {
    i18nKey: "time-picker.absolute.title"
  }, "Absolute time range")), !hideQuickRanges && /* @__PURE__ */ React__default.createElement(Icon, {
    name: !collapsed ? "angle-up" : "angle-down"
  }))), !collapsed && /* @__PURE__ */ React__default.createElement("div", {
    className: styles.body,
    id: "expanded-timerange"
  }, /* @__PURE__ */ React__default.createElement("div", {
    className: styles.form
  }, /* @__PURE__ */ React__default.createElement(TimeRangeContent, {
    value,
    onApply: onChange,
    timeZone,
    isFullscreen: false
  })), showHistory && /* @__PURE__ */ React__default.createElement(TimeRangeList, {
...
const FullScreenForm = (props) => {
  ...
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement("div", {
    ...
    i18nKey: "time-picker.absolute.title"
  }, "Absolute time range"))), /* @__PURE__ */ React__default.createElement(TimeRangeContent, {
    value,
    timeZone,
    fiscalYearStartMonth,
    onApply: onChange,
    isFullscreen: true,
    isReversed
  })), props.showHistory && /* @__PURE__ */ React__default.createElement("div", {
    className: styles.recent
  }, /* @__PURE__ */ React__default.createElement(TimeRangeList, {
    title: t("time-picker.absolute.recent-title", "Recently used absolute ranges"),
    options: historyOptions || [],
    onChange: onChangeTimeOption,
...
const EmptyRecentList = memo(() => {
  ...
  return /* @__PURE__ */ React__default.createElement("div", {
    ...
    i18nKey: "time-picker.content.empty-recent-list"
  }, /* @__PURE__ */ React__default.createElement("div", null, /* @__PURE__ */ React__default.createElement("span", null, "It looks like you haven't used this time picker before. As soon as you enter some time intervals, recently used intervals will appear here.")), /* @__PURE__ */ React__default.createElement("div", null, /* @__PURE__ */ React__default.createElement("a", {
    className: styles.link,
    href: "https://grafana.com/docs/grafana/latest/dashboards/time-range-controls",
    target: "_new"
  }, "Read the documentation"), /* @__PURE__ */ React__default.createElement("span", null, " to find out more about how to enter custom time ranges."))));
});
