...
const TimeRangeList = (props) => {
  ...
  return /* @__PURE__ */ React__default.createElement("section", {
    "aria-label": title
  }, /* @__PURE__ */ React__default.createElement("fieldset", null, /* @__PURE__ */ React__default.createElement("div", {
    className: styles.title
  }, /* @__PURE__ */ React__default.createElement(TimePickerTitle, null, title)), /* @__PURE__ */ React__default.createElement(Options, __spreadValues({}, props))));
};
const Options = ({ options, value, onChange, title }) => {
  ...
  }, options.map((option, index) => /* @__PURE__ */ React__default.createElement(TimeRangeOption, {
