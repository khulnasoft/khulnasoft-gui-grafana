...
const WideTimeZoneOption = (props, ref) => {
  ...
  }), isSelected && /* @__PURE__ */ React__default.createElement("span", null, /* @__PURE__ */ React__default.createElement(Icon, {
    name: "check"
  })))));
};
const CompactTimeZoneOption = (props, ref) => {
  const { children, innerProps, innerRef, data, isSelected, isFocused } = props;
  const theme = useTheme2();
  const styles = getStyles(theme);
  const timestamp = Date.now();
