...
const ButtonSelectComponent = (props) => {
  ...
  return /* @__PURE__ */ React__default.createElement(ButtonGroup, {
  ...
  }, /* @__PURE__ */ React__default.createElement(ToolbarButton, __spreadValues(__spreadValues({
    className,
    isOpen: state.isOpen,
    narrow,
    variant,
    ref
  }, buttonProps), restProps), (value == null ? void 0 : value.label) || (value == null ? void 0 : value.value)), state.isOpen && /* @__PURE__ */ React__default.createElement("div", {
    className: styles.menuWrapper
  }, /* @__PURE__ */ React__default.createElement(ClickOutsideWrapper, {
    onClick: state.close,
    parent: document,
    ...
    autoFocus: true,
    restoreFocus: true
  }, /* @__PURE__ */ React__default.createElement(Menu, __spreadValues({
    tabIndex: -1,
    onClose: state.close
  }, menuProps), options.map((item) => /* @__PURE__ */ React__default.createElement(MenuItem, {
    key: `${item.value}`,
