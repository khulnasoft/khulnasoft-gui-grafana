...
const Dropdown = React__default.memo(({ children, overlay, placement }) => {
  ...
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, React__default.cloneElement(typeof children === "function" ? children(visible) : children, {
    ref: setTriggerRef
  }), visible && /* @__PURE__ */ React__default.createElement(Portal, null, /* @__PURE__ */ React__default.createElement(FocusScope, {
    autoFocus: true
  }, /* @__PURE__ */ React__default.createElement("div", __spreadProps(__spreadValues({
    ref: setTooltipRef
  }, getTooltipProps()), {
    onClick: onOverlayClicked
  }), /* @__PURE__ */ React__default.createElement("div", __spreadValues({}, getArrowProps({ className: "tooltip-arrow" }))), /* @__PURE__ */ React__default.createElement(CSSTransition, {
