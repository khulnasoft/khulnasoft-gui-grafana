...
function FileListItem({ file: customFile, removeFile }) {
  ...
  const renderRightSide = () => {
    if (error) {
      return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement("span", {
      ...
      }, error.message), retryUpload && /* @__PURE__ */ React__default.createElement(IconButton, {
        type: "button",
        "aria-label": "Retry",
        name: "sync",
        tooltip: "Retry",
        ...
        onClick: retryUpload
      }), removeFile && /* @__PURE__ */ React__default.createElement(IconButton, {
    ...
    if (progress && file.size > progress) {
      return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement("progress", {
        className: styles.progressBar,
        max: file.size,
        value: progress
      }), /* @__PURE__ */ React__default.createElement("span", {
        className: styles.paddingLeft
      }, Math.round(progress / file.size * 100), "%"), abortUpload && /* @__PURE__ */ React__default.createElement(Button, {
        variant: "secondary",
        type: "button",
        fill: "text",
        onClick: abortUpload
    ...
    return removeFile && /* @__PURE__ */ React__default.createElement(IconButton, {
      name: "trash-alt",
      onClick: () => removeFile(customFile),
      tooltip: REMOVE_FILE,
      "aria-label": REMOVE_FILE,
  ...
  }, trimFileName(file.name)), /* @__PURE__ */ React__default.createElement("span", null, formattedValueToString(valueFormat))), /* @__PURE__ */ React__default.createElement("div", {
    className: styles.fileNameWrapper
  }, renderRightSide()));
}
