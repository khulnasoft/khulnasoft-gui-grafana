...
const GraphContextMenu = (_a) => {
  ...
  const renderHeader = () => {
    ...
    return /* @__PURE__ */ React__default.createElement(GraphContextMenuHeader, {
  ...
  const renderMenuGroupItems = () => {
    return itemsToRender == null ? void 0 : itemsToRender.map((group, index) => /* @__PURE__ */ React__default.createElement(MenuGroup, {
      key: `${group.label}${index}`,
      label: group.label
    }, (group.items || []).map((item) => /* @__PURE__ */ React__default.createElement(MenuItem, {
      key: `${item.label}`,
      url: item.url,
      label: item.label,
      target: item.target,
  ...
  return /* @__PURE__ */ React__default.createElement(ContextMenu, __spreadProps(__spreadValues({}, otherProps), {
...
const GraphContextMenuHeader = ({
  ...
  }, /* @__PURE__ */ React__default.createElement("strong", null, timestamp), /* @__PURE__ */ React__default.createElement(HorizontalGroup, null, /* @__PURE__ */ React__default.createElement("div", null, /* @__PURE__ */ React__default.createElement(SeriesIcon, {
    color: seriesColor
  }), /* @__PURE__ */ React__default.createElement("span", {
    className: styles.displayName
  }, displayName)), displayValue && /* @__PURE__ */ React__default.createElement(FormattedValueDisplay, {
    value: displayValue
  })));
};
