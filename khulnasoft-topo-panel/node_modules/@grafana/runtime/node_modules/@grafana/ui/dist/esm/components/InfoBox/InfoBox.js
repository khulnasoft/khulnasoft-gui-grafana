...
const InfoBox = React__default.memo(
  React__default.forwardRef(
    (_a, ref) => {
      ...
      return /* @__PURE__ */ React__default.createElement(Alert, __spreadProps(__spreadValues({
        severity,
        className
      }, otherProps), {
        ref,
        title
      }), /* @__PURE__ */ React__default.createElement("div", null, children), url && /* @__PURE__ */ React__default.createElement("a", {
        href: url,
        className: cx("external-link", styles.docsLink),
        target: "_blank",
        rel: "noreferrer"
