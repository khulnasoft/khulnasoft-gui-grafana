...
class UnThemedLogDetailsRow extends PureComponent {
  ...
  render() {
    ...
    const toggleFieldButton = !isLabel && showDetectedFields && showDetectedFields.includes(parsedKey) ? /* @__PURE__ */ React__default.createElement(IconButton, {
      name: "eye",
    ...
    return /* @__PURE__ */ React__default.createElement("tr", {
      className: cx(style.logDetailsValue, { [styles.noHoverBackground]: showFieldsStats })
    ...
    })), hasFilteringFunctionality && isLabel && /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement("td", {
      className: style.logsDetailsIcon
    }, /* @__PURE__ */ React__default.createElement(IconButton, {
      name: "search-plus",
    ...
    }))), hasDetectedFieldsFunctionality && !isLabel && /* @__PURE__ */ React__default.createElement("td", {
      className: style.logsDetailsIcon,
      colSpan: 2
    }, toggleFieldButton), /* @__PURE__ */ React__default.createElement("td", {
      className: style.logDetailsLabel
    }, parsedKey), /* @__PURE__ */ React__default.createElement("td", {
    ...
    }, parsedValue, mouseOver && /* @__PURE__ */ React__default.createElement(ClipboardButton, {
      getText: () => parsedValue,
    ...
    }), links == null ? void 0 : links.map((link) => /* @__PURE__ */ React__default.createElement("span", {
      key: link.title
    }, "\xA0", /* @__PURE__ */ React__default.createElement(DataLinkButton, {
      link
    }))), showFieldsStats && /* @__PURE__ */ React__default.createElement(LogLabelStats, {
      stats: fieldStats,
      label: parsedKey,
      value: parsedValue,
      rowCount: fieldCount,
