...
class UnThemedLogLabelStats extends PureComponent {
  render() {
    ...
    }, label, ": ", total, " of ", rowCount, " rows have that ", isLabel ? "label" : "field")), /* @__PURE__ */ React__default.createElement("div", {
      className: style.logsStatsBody
    }, topRows.map((stat) => /* @__PURE__ */ React__default.createElement(LogLabelStatsRow, __spreadProps(__spreadValues({
      key: stat.value
    }, stat), {
      active: stat.value === value
    }))), insertActiveRow && activeRow && /* @__PURE__ */ React__default.createElement(LogLabelStatsRow, __spreadProps(__spreadValues({
      key: activeRow.value
    }, activeRow), {
      active: true
    })), otherCount > 0 && /* @__PURE__ */ React__default.createElement(LogLabelStatsRow, {
      key: "__OTHERS__",
      count: otherCount,
      value: "Other",
