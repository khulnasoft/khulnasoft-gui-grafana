...
class UnThemedLogMessageAnsi extends PureComponent {
  ...
  render() {
    ...
    return chunks.map((chunk, index) => {
      var _a;
      const chunkText = ((_a = this.props.highlight) == null ? void 0 : _a.searchWords) ? /* @__PURE__ */ React__default.createElement(Highlighter, {
        key: index,
      ...
      return chunk.style ? /* @__PURE__ */ React__default.createElement("span", {
        key: index,
        style: chunk.style,
