...
class UnThemedLogRow extends PureComponent {
  ...
  renderLogRow(context, errors, hasMoreContextRows, updateLimit) {
    ...
    return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement("tr", {
    ...
    }, showDuplicates && /* @__PURE__ */ React__default.createElement("td", {
      className: style.logsRowDuplicates
    }, processedRow.duplicates && processedRow.duplicates > 0 ? `${processedRow.duplicates + 1}x` : null), /* @__PURE__ */ React__default.createElement("td", {
      className: cx({ [style.logsRowLevel]: !hasError })
    }, hasError && /* @__PURE__ */ React__default.createElement(Tooltip, {
      ...
      size: "xs"
    }))), enableLogDetails && /* @__PURE__ */ React__default.createElement("td", {
    ...
    })), showTime && /* @__PURE__ */ React__default.createElement("td", {
      className: style.logsRowLocalTime
    }, this.renderTimeStamp(row.timeEpochMs)), showLabels && processedRow.uniqueLabels && /* @__PURE__ */ React__default.createElement("td", {
      className: style.logsRowLabels
    }, /* @__PURE__ */ React__default.createElement(LogLabels, {
      labels: processedRow.uniqueLabels
    })), showDetectedFields && showDetectedFields.length > 0 ? /* @__PURE__ */ React__default.createElement(LogRowMessageDetectedFields, {
      row: processedRow,
      showDetectedFields,
      getFieldLinks,
      wrapLogMessage
    }) : /* @__PURE__ */ React__default.createElement(LogRowMessage, {
      row: processedRow,
      getRows,
      errors,
      hasMoreContextRows,
    ...
    })), this.state.showDetails && /* @__PURE__ */ React__default.createElement(LogDetails, {
      className: logRowBackground,
      showDuplicates,
      getFieldLinks,
      onClickFilterLabel,
  ...
  render() {
    ...
    if (showContext) {
      return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement(LogRowContextProvider, {
        row,
        getRowContext,
        logsSortOrder
