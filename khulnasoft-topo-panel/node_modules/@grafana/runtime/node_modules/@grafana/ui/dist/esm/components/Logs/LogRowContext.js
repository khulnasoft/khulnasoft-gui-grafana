...
const LogRowContextGroupHeader = ({
  ...
  return /* @__PURE__ */ React__default.createElement("div", {
    ...
    className: css`
          opacity: 0.6;
        `
  }, "Found ", rows.length, " rows."), (rows.length >= 10 || rows.length > 10 && rows.length % 10 !== 0) && canLoadMoreRows && /* @__PURE__ */ React__default.createElement("span", {
    className: css`
            margin-left: 10px;
            &:hover {
...
const LogRowContextGroup = ({
  ...
  }, shouldScrollToBottom && !error && /* @__PURE__ */ React__default.createElement(LogRowContextGroupHeader, __spreadValues({}, headerProps)), /* @__PURE__ */ React__default.createElement("div", {
    className: logs
  ...
  }, !error && /* @__PURE__ */ React__default.createElement(List, {
    items: rows,
    renderItem: (item) => {
      return /* @__PURE__ */ React__default.createElement("div", {
        className: css`
                        padding: 5px 0;
                      `
      }, typeof item === "string" && textUtil.hasAnsiCodes(item) ? /* @__PURE__ */ React__default.createElement(LogMessageAnsi, {
        value: item
      }) : item);
    }
  }), error && /* @__PURE__ */ React__default.createElement(Alert, {
    title: error
  })))), !shouldScrollToBottom && !error && /* @__PURE__ */ React__default.createElement(LogRowContextGroupHeader, __spreadValues({}, headerProps)));
};
const LogRowContext = ({
  row,
  context,
  ...
  return /* @__PURE__ */ React__default.createElement(ClickOutsideWrapper, {
    onClick: onOutsideClick
  }, /* @__PURE__ */ React__default.createElement("div", {
    onClick: (e) => e.stopPropagation()
  }, context.after && /* @__PURE__ */ React__default.createElement(LogRowContextGroup, {
    rows: context.after,
    ...
    onLoadMoreContext
  }), context.before && /* @__PURE__ */ React__default.createElement(LogRowContextGroup, {
    onLoadMoreContext,
