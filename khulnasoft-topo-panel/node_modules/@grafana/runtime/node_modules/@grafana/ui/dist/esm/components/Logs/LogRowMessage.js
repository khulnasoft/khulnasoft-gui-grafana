...
function renderLogMessage(hasAnsi, entry, highlights, highlightClassName) {
  ...
  if (hasAnsi) {
    ...
    return /* @__PURE__ */ React__default.createElement(LogMessageAnsi, {
      value: entry,
      highlight
    });
...
class UnThemedLogRowMessage extends PureComponent {
  ...
  render() {
    ...
    return /* @__PURE__ */ React__default.createElement("td", {
      style: contextIsOpen ? { position: "unset" } : void 0,
    ...
    }, contextIsOpen && context && /* @__PURE__ */ React__default.createElement(LogRowContext, {
      row,
      context,
      errors,
      wrapLogMessage,
      ...
      className: cx(styles.positionRelative, { [styles.rowWithContext]: contextIsOpen })
    }, renderLogMessage(hasAnsi, restructuredEntry, row.searchWords, style.logsRowMatchHighLight)), !contextIsOpen && (showContextToggle == null ? void 0 : showContextToggle(row)) && /* @__PURE__ */ React__default.createElement("span", {
