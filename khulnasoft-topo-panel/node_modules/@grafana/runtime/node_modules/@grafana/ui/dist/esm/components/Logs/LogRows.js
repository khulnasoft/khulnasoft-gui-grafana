...
class UnThemedLogRows extends PureComponent {
  ...
  render() {
    ...
    return /* @__PURE__ */ React__default.createElement("table", {
    ...
    }, /* @__PURE__ */ React__default.createElement("tbody", null, hasData && firstRows.map((row, index) => /* @__PURE__ */ React__default.createElement(LogRow, {
      key: row.uid,
      getRows,
      getRowContext,
      row,
      ...
      forceEscape,
      onLogRowHover
    })), hasData && renderAll && lastRows.map((row, index) => /* @__PURE__ */ React__default.createElement(LogRow, {
      key: row.uid,
      getRows,
      getRowContext,
      row,
      ...
      forceEscape,
      onLogRowHover
    })), hasData && !renderAll && /* @__PURE__ */ React__default.createElement("tr", null, /* @__PURE__ */ React__default.createElement("td", {
      colSpan: 5
