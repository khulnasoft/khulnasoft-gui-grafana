...
const MenuItem = React__default.memo(
  React__default.forwardRef((props, ref) => {
    ...
    return /* @__PURE__ */ React__default.createElement(ItemElement, __spreadValues({
      target,
      className: itemStyle,
      ...
      tabIndex
    }, disabledProps), /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, icon && /* @__PURE__ */ React__default.createElement(Icon, {
      name: icon,
      className: styles.icon,
      "aria-hidden": true
    }), label), hasSubMenu && /* @__PURE__ */ React__default.createElement(SubMenu, {
      items: childItems,
