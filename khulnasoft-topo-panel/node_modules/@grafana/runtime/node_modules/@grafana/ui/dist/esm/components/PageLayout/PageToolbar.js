...
import '../DateTimePickers/TimeRangePicker/CalendarBody.js';
...
const PageToolbar = React__default.memo(
  ({
    ...
    const titleEl = /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement("span", {
      className: styles.truncateText
    }, title), section && /* @__PURE__ */ React__default.createElement("span", {
    ...
    return /* @__PURE__ */ React__default.createElement("nav", {
    ...
    }, pageIcon && !onGoBack && /* @__PURE__ */ React__default.createElement("div", {
      className: styles.pageIcon
    }, /* @__PURE__ */ React__default.createElement(Icon, {
      name: pageIcon,
      size: "lg",
      "aria-hidden": true
    })), onGoBack && /* @__PURE__ */ React__default.createElement("div", {
      className: styles.pageIcon
    ...
    }, parent && parentHref && /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement(Link, {
      ...
      href: parentHref
    }, parent, " ", /* @__PURE__ */ React__default.createElement("span", {
      className: styles.parentIcon
    })), titleHref && /* @__PURE__ */ React__default.createElement("span", {
      className: cx(styles.titleText, styles.titleDivider),
      "aria-hidden": true
    }, "/")), (title || Boolean(leftItems == null ? void 0 : leftItems.length)) && /* @__PURE__ */ React__default.createElement("div", {
      className: styles.titleWrapper
    }, title && /* @__PURE__ */ React__default.createElement("h1", {
      className: styles.h1Styles
    }, titleHref ? /* @__PURE__ */ React__default.createElement(Link, {
      "aria-label": "Search dashboard by name",
      className: cx(styles.titleText, styles.titleLink),
      href: titleHref
    }, titleEl) : /* @__PURE__ */ React__default.createElement("div", {
      className: styles.titleText
    }, titleEl)), leftItems == null ? void 0 : leftItems.map((child, index) => /* @__PURE__ */ React__default.createElement("div", {
      className: styles.leftActionItem,
      key: index
    }, child))))), /* @__PURE__ */ React__default.createElement(ToolbarButtonRow, {
      alignment: "right"
    }, React__default.Children.toArray(children).filter(Boolean)));
  }
);
