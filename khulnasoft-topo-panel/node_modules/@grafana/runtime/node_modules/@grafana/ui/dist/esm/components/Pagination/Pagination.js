...
const Pagination = ({
  ...
  const pageButtons = useMemo(() => {
    ...
    const getListItem = (page, variant) => /* @__PURE__ */ React__default.createElement("li", {
      key: page,
  ...
  return /* @__PURE__ */ React__default.createElement("div", {
  ...
  }, /* @__PURE__ */ React__default.createElement("ol", null, /* @__PURE__ */ React__default.createElement("li", {
    className: styles.item
  }, /* @__PURE__ */ React__default.createElement(Button, {
    "aria-label": "previous",
    size: "sm",
    ...
    name: "angle-left"
  }))), pageButtons, /* @__PURE__ */ React__default.createElement("li", {
    className: styles.item
  }, /* @__PURE__ */ React__default.createElement(Button, {
    "aria-label": "next",
    size: "sm",
