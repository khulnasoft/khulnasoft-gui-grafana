...
const SecretFormField = (_a) => {
  ...
  return /* @__PURE__ */ React__default.createElement(FormField, {
    ...
    interactive,
    labelWidth,
    inputEl: isConfigured ? /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement("input", __spreadValues({
      type: "text",
      className: cx(`gf-form-input width-${inputWidth}`, styles.noRadiusInput),
      disabled: true,
      value: "configured"
    }, omit(inputProps, "value"))), /* @__PURE__ */ React__default.createElement(Button, {
      onClick: onReset,
      variant: "secondary",
      type: "button"
    }, "Reset")) : /* @__PURE__ */ React__default.createElement("input", __spreadValues({
      type: "password",
