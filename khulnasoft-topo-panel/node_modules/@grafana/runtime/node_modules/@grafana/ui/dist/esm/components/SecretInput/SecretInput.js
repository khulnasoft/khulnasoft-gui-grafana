...
const SecretInput = (_a) => {
  ...
  return /* @__PURE__ */ React.createElement(HorizontalGroup, null, !isConfigured && /* @__PURE__ */ React.createElement(Input, __spreadProps(__spreadValues({}, props), {
    type: "password"
  })), isConfigured && /* @__PURE__ */ React.createElement(Input, __spreadProps(__spreadValues({}, props), {
    type: "text",
    disabled: true,
    value: CONFIGURED_TEXT
  })), isConfigured && /* @__PURE__ */ React.createElement(Button, {
    onClick: onReset,
    variant: "secondary"
  }, RESET_BUTTON_TEXT));
};
