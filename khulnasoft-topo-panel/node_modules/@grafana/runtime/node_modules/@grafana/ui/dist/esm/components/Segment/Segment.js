...
function Segment(_a) {
  ...
  if (!expanded) {
    ...
    return /* @__PURE__ */ React__default.createElement(Label, {
      disabled,
      Component: Component || /* @__PURE__ */ React__default.createElement(InlineLabel, {
        className: cx(
          styles.segment,
          {
  ...
  return /* @__PURE__ */ React__default.createElement(SegmentSelect, __spreadProps(__spreadValues({}, rest), {
