...
const CustomControl = (props) => {
  ...
  return /* @__PURE__ */ React__default.createElement(InputControl, {
    ref: innerRef,
    innerProps,
...
function SelectBase({
  ...
  if (isMulti && loadOptions) {
    ...
    if (isMulti && value && Array.isArray(value) && !loadOptions) {
      selectedValue = value.map((v) => {
        var _a;
        return findSelectedValue((_a = v.value) != null ? _a : v, options);
      });
    } else if (loadOptions) {
  ...
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement(ReactSelectComponent, __spreadValues(__spreadValues(__spreadValues({
    ref: reactSelectRef,
    components: __spreadValues({
      ...
      DropdownIndicator(props) {
        return /* @__PURE__ */ React__default.createElement(DropdownIndicator, {
          isOpen: props.selectProps.menuIsOpen
        });
      },
      SingleValue(props) {
        return /* @__PURE__ */ React__default.createElement(SingleValue, __spreadProps(__spreadValues({}, props), {
          disabled
        }));
      },
      SelectContainer,
...
function defaultFormatCreateLabel(input) {
  ...
  }, /* @__PURE__ */ React__default.createElement("div", null, input), /* @__PURE__ */ React__default.createElement("div", {
    style: { flexGrow: 1 }
