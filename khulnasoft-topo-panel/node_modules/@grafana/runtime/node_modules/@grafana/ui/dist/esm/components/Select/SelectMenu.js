...
const SelectMenu = ({ children, maxHeight, innerRef, innerProps }) => {
  ...
  return /* @__PURE__ */ React__default.createElement("div", __spreadProps(__spreadValues({}, innerProps), {
...
const VirtualizedSelectMenu = ({ children, maxHeight, options, getValue }) => {
  ...
  }, ({ index, style }) => /* @__PURE__ */ React__default.createElement("div", {
    style: __spreadProps(__spreadValues({}, style), { overflow: "hidden" })
  }, children[index]));
};
...
const SelectMenuOptions = ({
  ...
  }), data.imgUrl && /* @__PURE__ */ React__default.createElement("img", {
    className: styles.optionImage,
    src: data.imgUrl,
    alt: data.label || data.value
  }), /* @__PURE__ */ React__default.createElement("div", {
    className: styles.optionBody
  }, /* @__PURE__ */ React__default.createElement("span", null, renderOptionLabel ? renderOptionLabel(data) : children), data.description && /* @__PURE__ */ React__default.createElement("div", {
