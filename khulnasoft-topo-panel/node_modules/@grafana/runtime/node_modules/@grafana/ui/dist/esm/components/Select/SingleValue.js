...
const SingleValue = (props) => {
  ...
  return /* @__PURE__ */ React__default.createElement(components.SingleValue, __spreadProps(__spreadValues({}, props), {
    className: cx(styles.singleValue, isDisabled && styles.disabled, props.selectProps.menuIsOpen && styles.isOpen)
  }), data.imgUrl ? /* @__PURE__ */ React__default.createElement(FadeWithImage, {
    loading,
    imgUrl: data.imgUrl,
    styles,
    alt: (_a = data.label) != null ? _a : data.value
  }) : /* @__PURE__ */ React__default.createElement(SlideOutTransition, {
    horizontal: true,
    size: 16,
    visible: loading,
    duration: 150
...
const FadeWithImage = (props) => {
  ...
  }, /* @__PURE__ */ React__default.createElement(FadeTransition, {
    duration: 150,
