...
const Switch = React__default.forwardRef(
  (_a, ref) => {
    var _b = _a, { value, checked, disabled, onChange, id, label } = _b, inputProps = __objRest(_b, ["value", "checked", "disabled", "onChange", "id", "label"]);
    if (checked) {
    ...
    return /* @__PURE__ */ React__default.createElement("div", {
      ...
      "aria-label": label != null ? label : "Toggle switch"
    }));
  }
);
...
const InlineSwitch = React__default.forwardRef(
  (_c, ref) => {
    ...
    return /* @__PURE__ */ React__default.createElement("div", {
      className: cx(styles.inlineContainer, className)
    }, showLabel && /* @__PURE__ */ React__default.createElement("label", {
      htmlFor: id,
      className: cx(styles.inlineLabel, value && styles.inlineLabelEnabled, "inline-switch-label")
    }, label), /* @__PURE__ */ React__default.createElement(Switch, __spreadProps(__spreadValues({}, props), {
      id,
      label,
      ref,
      value
