...
function TabbedContainer(props) {
  ...
  }, /* @__PURE__ */ React__default.createElement(TabsBar, {
    className: styles.tabs
  }, tabs.map((t) => /* @__PURE__ */ React__default.createElement(Tab, {
    key: t.value,
    label: t.label,
