...
import { BarGaugeDisplayMode, BarGauge } from '../BarGauge/BarGauge.js';
...
const BarGaugeCell = (props) => {
  ...
  const renderComponent = (menuProps) => {
    ...
    return /* @__PURE__ */ React__default.createElement(BarGauge, {
      width: innerWidth,
  ...
  }), hasLinks && /* @__PURE__ */ React__default.createElement(DataLinksContextMenu, {
    links: getLinks,
    style: { display: "flex", width: "100%" }
  }, (api) => renderComponent(api)), !hasLinks && /* @__PURE__ */ React__default.createElement(BarGauge, {
    width: innerWidth,
    height: tableStyles.cellHeightInner,
    field: config,
    display: field.display,
