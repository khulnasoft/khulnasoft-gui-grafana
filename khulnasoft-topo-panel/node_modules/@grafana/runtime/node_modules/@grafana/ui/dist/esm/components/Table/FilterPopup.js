...
const FilterPopup = ({ column: { preFilteredRows, filterValue, setFilter }, onClose, field }) => {
  ...
  return /* @__PURE__ */ React__default.createElement(ClickOutsideWrapper, {
  ...
  }, /* @__PURE__ */ React__default.createElement(VerticalGroup, {
    spacing: "lg"
  }, /* @__PURE__ */ React__default.createElement(VerticalGroup, {
    spacing: "xs"
  ...
  }, "Filter by values:"), /* @__PURE__ */ React__default.createElement(IconButton, {
    name: "text-fields",
    tooltip: "Match case",
  ...
  }), /* @__PURE__ */ React__default.createElement(FilterList, {
    onChange: setValues,
    values,
    options,
    ...
    variant: "secondary",
    onClick: onCancel
  }, "Cancel")), clearFilterVisible && /* @__PURE__ */ React__default.createElement(HorizontalGroup, null, /* @__PURE__ */ React__default.createElement(Button, {
    fill: "text",
    size: "sm",
