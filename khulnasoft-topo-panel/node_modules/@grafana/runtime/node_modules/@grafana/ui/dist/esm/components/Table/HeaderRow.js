...
function renderHeaderCell(column, tableStyles, showTypeIcons) {
  ...
  return /* @__PURE__ */ React__default.createElement("div", __spreadProps(__spreadValues({
    ...
    role: "columnheader"
  }), column.canSort && /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement("button", __spreadProps(__spreadValues({}, column.getSortByToggleProps()), {
    className: tableStyles.headerCellLabel
  }), showTypeIcons && /* @__PURE__ */ React__default.createElement(Icon, {
    name: getFieldTypeIcon(field),
    title: field == null ? void 0 : field.type,
    size: "sm",
    className: tableStyles.typeIcon
  }), /* @__PURE__ */ React__default.createElement("div", null, column.render("Header")), /* @__PURE__ */ React__default.createElement("div", null, column.isSorted && (column.isSortedDesc ? /* @__PURE__ */ React__default.createElement(Icon, {
    name: "arrow-down"
  }) : /* @__PURE__ */ React__default.createElement(Icon, {
    name: "arrow-up"
  })))), column.canFilter && /* @__PURE__ */ React__default.createElement(Filter, {
    column,
    tableStyles,
    field
  })), !column.canSort && column.render("Header"), !column.canSort && column.canFilter && /* @__PURE__ */ React__default.createElement(Filter, {
    column,
    tableStyles,
    field
  }), column.canResize && /* @__PURE__ */ React__default.createElement("div", __spreadProps(__spreadValues({}, column.getResizerProps()), {
