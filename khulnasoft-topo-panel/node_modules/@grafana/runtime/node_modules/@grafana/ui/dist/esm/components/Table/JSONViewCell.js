...
function JSONViewCell(props) {
  ...
  }, displayValue), hasLinks && /* @__PURE__ */ React__default.createElement(DataLinksContextMenu, {
    links: () => getCellLinks(field, row) || []
  }, (api) => {
    return /* @__PURE__ */ React__default.createElement("div", {
      onClick: api.openMenu,
      className: api.targetClassName
    }, displayValue);
  })), inspectEnabled && /* @__PURE__ */ React__default.createElement(CellActions, __spreadProps(__spreadValues({}, props), {
    previewMode: "code"
  })));
}
