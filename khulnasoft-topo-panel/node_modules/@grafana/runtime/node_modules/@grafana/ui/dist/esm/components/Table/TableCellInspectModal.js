...
function TableCellInspectModal({ value, onDismiss, mode }) {
  ...
  return /* @__PURE__ */ React__default.createElement(Modal, {
    ...
    isOpen: true,
    title: "Inspect value"
  }, mode === "code" ? /* @__PURE__ */ React__default.createElement(CodeEditor, {
    width: "100%",
    height: 500,
    language: "json",
    ...
    value: text,
    readOnly: true
  }) : /* @__PURE__ */ React__default.createElement("pre", null, text), /* @__PURE__ */ React__default.createElement(Modal.ButtonRow, null, /* @__PURE__ */ React__default.createElement(ClipboardButton, {
    icon: "copy",
    getText: () => text
  }, "Copy to Clipboard")));
}
