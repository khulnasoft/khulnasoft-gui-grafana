...
const VerticalTab = React__default.forwardRef(
  (_a, ref) => {
    ...
    const content = () => /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, icon && /* @__PURE__ */ React__default.createElement(Icon, {
      name: icon
    }), label, typeof counter === "number" && /* @__PURE__ */ React__default.createElement(Counter, {
      value: counter
    }), Suffix && /* @__PURE__ */ React__default.createElement(Suffix, {
      className: tabsStyles.suffix
    }));
    const linkClass = cx(tabsStyles.link, active && tabsStyles.activeStyle);
    return /* @__PURE__ */ React__default.createElement("a", __spreadProps(__spreadValues({
      href,
      className: linkClass
    }, otherProps), {
      onClick: onChangeTab,
