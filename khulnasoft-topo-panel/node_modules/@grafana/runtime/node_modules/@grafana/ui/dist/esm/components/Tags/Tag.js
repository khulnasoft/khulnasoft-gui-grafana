...
const Tag = forwardRef((_a, ref) => {
  ...
  return onClick ? /* @__PURE__ */ React__default.createElement("button", __spreadProps(__spreadValues({}, rest), {
    className: classes,
    onClick: onTagClick,
    ref
  }), icon && /* @__PURE__ */ React__default.createElement(Icon, {
    name: icon
  }), name) : /* @__PURE__ */ React__default.createElement("span", __spreadProps(__spreadValues({}, rest), {
    className: classes,
    ref
  }), icon && /* @__PURE__ */ React__default.createElement(Icon, {
    name: icon
