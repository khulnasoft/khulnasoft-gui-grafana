...
const TagList = memo(
  forwardRef(({ displayMax, tags, icon, onClick, className, getAriaLabel }, ref) => {
    ...
    return /* @__PURE__ */ React__default.createElement("ul", {
      ...
      "aria-label": "Tags",
      ref
    }, tagsToDisplay.map((tag, i) => /* @__PURE__ */ React__default.createElement("li", {
      className: styles.li,
      key: tag
      ...
      "data-tag-id": i
    }))), displayMax && displayMax > 0 && numTags - displayMax > 0 && /* @__PURE__ */ React__default.createElement("span", {
