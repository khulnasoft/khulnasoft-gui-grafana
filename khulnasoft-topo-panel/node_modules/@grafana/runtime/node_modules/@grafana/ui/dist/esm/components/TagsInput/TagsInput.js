...
const TagsInput = ({
  ...
  return /* @__PURE__ */ React__default.createElement("div", {
    className: cx(styles.wrapper, className, width ? css({ width: theme.spacing(width) }) : "")
  ...
  }), (tags == null ? void 0 : tags.length) > 0 && /* @__PURE__ */ React__default.createElement("ul", {
    className: styles.tags
  }, tags.map((tag) => /* @__PURE__ */ React__default.createElement(TagItem, {
    key: tag,
    name: tag,
    onRemove,
    disabled
