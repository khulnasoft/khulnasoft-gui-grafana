...
import { PlotLegend } from '../uPlot/PlotLegend.js';
...
class UnthemedTimeSeries extends Component {
  constructor() {
    ...
    this.renderLegend = (config) => {
      ...
      return /* @__PURE__ */ React__default.createElement(PlotLegend, __spreadValues({
        data: frames,
        config
      }, legend));
    };
  ...
  render() {
    return /* @__PURE__ */ React__default.createElement(GraphNG, __spreadProps(__spreadValues({}, this.props), {
