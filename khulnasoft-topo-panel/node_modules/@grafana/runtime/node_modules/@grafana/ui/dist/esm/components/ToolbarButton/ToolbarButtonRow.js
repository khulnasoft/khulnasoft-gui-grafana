...
const ToolbarButtonRow = forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React__default.createElement("div", __spreadValues({
    ...
    }, rest), childrenWithoutNull.map((child, index) => /* @__PURE__ */ React__default.createElement("div", {
      key: index,
      style: { order: index, visibility: childVisibility[index] ? "visible" : "hidden" },
      className: styles.childWrapper
    }, child)), childVisibility.includes(false) && /* @__PURE__ */ React__default.createElement("div", {
      ref: overflowRef,
      ...
      iconOnly: true,
      narrow: true
    }), showOverflowItems && /* @__PURE__ */ React__default.createElement(FocusScope, {
      contain: true,
      autoFocus: true
    }, /* @__PURE__ */ React__default.createElement("div", __spreadValues(__spreadValues({
      className: styles.overflowItems,
      ref: overflowItemsRef
    }, overlayProps), dialogProps), childrenWithoutNull.map((child, index) => !childVisibility[index] && child)))));
  }
);
