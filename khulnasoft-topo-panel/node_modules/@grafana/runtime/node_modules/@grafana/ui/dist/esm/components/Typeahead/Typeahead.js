...
class Typeahead extends PureComponent {
  ...
  render() {
    ...
    return /* @__PURE__ */ React__default.createElement(Portal, {
    ...
    }, /* @__PURE__ */ React__default.createElement(FixedSizeList, {
      ref: this.listRef,
      ...
      return /* @__PURE__ */ React__default.createElement(TypeaheadItem, {
    ...
    })), showDocumentation && /* @__PURE__ */ React__default.createElement(TypeaheadInfo, {
      height: listHeight,
