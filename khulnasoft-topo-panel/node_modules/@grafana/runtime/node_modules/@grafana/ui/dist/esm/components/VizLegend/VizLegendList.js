...
const VizLegendList = ({
  ...
  if (!itemRenderer) {
    itemRenderer = (item) => /* @__PURE__ */ React__default.createElement(VizLegendListItem, {
      item,
      onLabelClick,
      onLabelMouseOver,
      onLabelMouseOut,
  ...
  switch (placement) {
    case "right": {
      ...
      return /* @__PURE__ */ React__default.createElement("div", {
        className: cx(styles.rightWrapper, className)
    ...
    default: {
      ...
      return /* @__PURE__ */ React__default.createElement("div", {
        className: cx(styles.bottomWrapper, className)
      }, /* @__PURE__ */ React__default.createElement("div", {
        className: styles.section
      }, /* @__PURE__ */ React__default.createElement(InlineList, {
