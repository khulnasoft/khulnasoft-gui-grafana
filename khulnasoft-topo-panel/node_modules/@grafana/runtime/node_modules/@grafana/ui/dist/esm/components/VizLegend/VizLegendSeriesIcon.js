...
const VizLegendSeriesIcon = React__default.memo(({ seriesName, color, gradient, readonly }) => {
  ...
  if (seriesName && onSeriesColorChange && color && !readonly) {
    return /* @__PURE__ */ React__default.createElement(SeriesColorPicker, {
      color,
      onChange,
      enableNamedColors: true
    }, ({ ref, showColorPicker, hideColorPicker }) => /* @__PURE__ */ React__default.createElement(SeriesIcon, {
      color,
      className: "pointer",
      ref,
  ...
  return /* @__PURE__ */ React__default.createElement(SeriesIcon, {
    color,
    gradient
  });
});
