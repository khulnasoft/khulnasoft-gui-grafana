...
const LegendTableItem = ({
  ...
  }, /* @__PURE__ */ React__default.createElement("td", null, /* @__PURE__ */ React__default.createElement("span", {
    className: styles.itemWrapper
  }, /* @__PURE__ */ React__default.createElement(VizLegendSeriesIcon, {
    color: item.color,
  ...
  }, item.label, " ", item.yAxis === 2 && /* @__PURE__ */ React__default.createElement("span", {
    className: styles.yAxisLabel
  }, "(right y-axis)")))), item.getDisplayValues && item.getDisplayValues().map((stat, index) => {
