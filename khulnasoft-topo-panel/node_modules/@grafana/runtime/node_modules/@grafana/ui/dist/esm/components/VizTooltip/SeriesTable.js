...
const SeriesTableRow = ({ color, label, value, isActive }) => {
  ...
  return /* @__PURE__ */ React__default.createElement("div", {
    "data-testid": "SeriesTableRow",
    className: cx(styles.seriesTableRow, isActive && styles.activeSeries)
  }, color && /* @__PURE__ */ React__default.createElement("div", {
    className: styles.seriesTableCell
  }, /* @__PURE__ */ React__default.createElement(SeriesIcon, {
    color,
    className: styles.icon
  })), label && /* @__PURE__ */ React__default.createElement("div", {
    className: cx(styles.seriesTableCell, styles.label)
  }, label), value && /* @__PURE__ */ React__default.createElement("div", {
    className: cx(styles.seriesTableCell, styles.value)
  }, value));
};
const SeriesTable = ({ timestamp, series }) => {
  const styles = useStyles2(getSeriesTableRowStyles);
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, timestamp && /* @__PURE__ */ React__default.createElement("div", {
    className: styles.timestamp,
    "aria-label": "Timestamp"
  }, timestamp), series.map((s, i) => {
    return /* @__PURE__ */ React__default.createElement(SeriesTableRow, {
      isActive: s.isActive,
      label: s.label,
      color: s.color,
      value: s.value,
