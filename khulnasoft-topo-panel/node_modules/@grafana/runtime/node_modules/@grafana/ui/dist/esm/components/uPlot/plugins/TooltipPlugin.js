...
const TooltipPlugin = (_a) => {
  ...
  if (!renderTooltip) {
    if (mode === TooltipDisplayMode.Single && focusedSeriesIdx !== null) {
      ...
      tooltip = /* @__PURE__ */ React__default.createElement(SeriesTable, {
        series: [
          {
  ...
  return /* @__PURE__ */ React__default.createElement(Portal, null, tooltip && coords && /* @__PURE__ */ React__default.createElement(VizTooltipContainer, {
