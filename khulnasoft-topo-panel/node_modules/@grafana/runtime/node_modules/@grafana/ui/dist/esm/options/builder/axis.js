  ...
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement("div", {
    ...
    onChange: (v) => {
      ...
      onChange(__spreadProps(__spreadValues({}, value), {
        type: v,
        log: v === ScaleDistribution.Linear ? void 0 : (_a2 = value.log) != null ? _a2 : 2
      }));
    }
  })), (type === ScaleDistribution.Log || type === ScaleDistribution.Symlog) && /* @__PURE__ */ React__default.createElement(Field, {
    label: "Log base"
  }, /* @__PURE__ */ React__default.createElement(Select, {
    options: LOG_DISTRIBUTION_OPTIONS,
    value: (_b = value.log) != null ? _b : 2,
    onChange: (v) => {
      onChange(__spreadProps(__spreadValues({}, value), {
        log: v.value
      }));
    }
  })), type === ScaleDistribution.Symlog && /* @__PURE__ */ React__default.createElement(Field, {
